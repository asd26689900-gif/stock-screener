// Vercel Serverless — 美股/日股行情（Yahoo Finance v8 chart，一次平行抓取）
// GET /api/global
...
async function fetchQuote(sym) {
  ...
  try {
    ...
    if (!res || !res.timestamp || !res.timestamp.length) return null;
